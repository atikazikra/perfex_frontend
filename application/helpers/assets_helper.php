...
// my custom theme falcon files
//css&venderfiles
$CI->app_css->add('falcon-theme', 'assets/falcon/css/theme.css');
// $CI->app_css->add('falcon-prism', 'assets/falcon/vendors/prism/prism-okaidia.css');

//$CI->app_css->add('falcon-simplebar', 'assets/falcon/vendors/simplebar/simplebar.min.css');
//$CI->app_css->add('falcon-flatpickr', 'assets/falcon/vendors/flatpickr/flatpickr.min.css');
//$CI->app_css->add('falcon-leaflet-default', 'assets/falcon/vendors/leaflet.markercluster/MarkerCluster.Default.css');
//$CI->app_css->add('falcon-markercluster', 'assets/falcon/vendors/leaflet.markercluster/MarkerCluster.css');
//$CI->app_css->add('falcon-leaflet', 'assets/falcon/vendors/leaflet/leaflet.css');

$CI->app_scripts->add('falcon-configjs', 'assets/falcon/js/config.js');

//$CI->app_scripts->add('falcon-simplebar-js', 'assets/falcon/vendors/simplebar/simplebar.min.js');



//js files
// $CI->app_scripts->add('falcon-prpper', 'assets/falcon/vendors/popper/popper.min.js');
// $CI->app_scripts->add('falcon-prismjs', 'assets/falcon/vendors/prism/prism.js');


$CI->app_scripts->add('falcon-bootstrapjs', 'assets/falcon/vendors/bootstrap/bootstrap.min.js');
$CI->app_scripts->add('falcon-anchorjs', 'assets/falcon/vendors/anchorjs/anchor.min.js');


// // $CI->app_scripts->add('falcon-isjs', 'assets/falcon/vendors/is/is.min.js');
// $CI->app_scripts->add('falcon-chartjs', 'assets/falcon/vendors/chart/chart.min.js');
// $CI->app_scripts->add('falcon-leafletjs', 'assets/falcon/vendors/leaflet/leaflet.js');
// $CI->app_scripts->add('falcon-markerclusterjs', 'assets/falcon/vendors/leaflet.markercluster/leaflet.markercluster.js');
// $CI->app_scripts->add('falcon-colorfilterjs', 'assets/falcon/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js');
// $CI->app_scripts->add('falcon-countupjs', 'assets/falcon/vendors/countup/countUp.umd.js');

// $CI->app_scripts->add('falcon-echartjs', 'assets/falcon/vendors/echarts/echarts.min.js');
// $CI->app_scripts->add('falcon-dayjs', 'assets/falcon/vendors/dayjs/dayjs.min.js');
// $CI->app_scripts->add('falcon-flatsjs', 'assets/falcon/js/flatpickr.js');


 $CI->app_scripts->add('falcon-fontawesom', 'assets/falcon/vendors/fontawesome/all.min.js');
 $CI->app_scripts->add('falcon-loadsh', 'assets/falcon/vendors/lodash/lodash.min.js');


$CI->app_scripts->add('falcon-listjs', 'assets/falcon/vendors/list.js/list.min.js');
$CI->app_scripts->add('falcon-themejs', 'assets/falcon/js/theme.js');


// my custom theme falcon file end



    if (is_rtl()) {
      //  $CI->app_css->add('bootstrap-rtl-css', 'assets/plugins/bootstrap-arabic/css/bootstrap-arabic.min.css');
      //  $CI->app_css->add('falcon-theme-rtl', 'assets/falcon/css/theme-rtl.css');
...
function add_calendar_assets($group = 'admin')
{
    ...
    $CI     = &get_instance();
    // $CI->app_css->add('falcon-calender', 'assets/falcon/vendors/fullcalendar/main.min.css');
    // $CI->app_scripts->add('falcon-calenderjs', 'assets/falcon/vendors/fullcalendar/main.min.js');
