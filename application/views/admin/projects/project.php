            ...
            <h4 class="text-center text-uppercase mt-2 mb-3 text-semibold">
                ...
                <div class="card">
                            ...
                            <div class="horizontal-tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="nav-item">
                                        <a href="#tab_project" aria-controls="tab_project" role="tab" data-toggle="tab" class="nav-link ">
                                            <?php echo _l('project'); ?>
                                        </a>
                                    </li>
                                    <li role="presentation" class="nav-item">
                                        <a href="#tab_settings" aria-controls="tab_settings" role="tab" data-toggle="tab" class="nav-link">
                    ...
                    <div class="card-footer text-right">
                        <button type="submit" data-form="#project_form" class="btn btn-falcon-success" autocomplete="off"
