            ...
            <div class="col-md-12">
                <div class="_buttons mb-2 mb-sm-4">
                    <a href="#" onclick="init_lead(); return false;"
                        class="btn btn-falcon-info mright5 pull-left display-block">
                        <i class="fas fa-plus-circle me-1"></i>
                        <?php echo _l('new_lead'); ?>
                    </a>
                    <?php if (is_admin() || get_option('allow_non_admin_members_to_import_leads') == '1') { ?>
                    <a href="<?php echo admin_url('leads/import'); ?>"
                        class="ms-1 btn btn-falcon-info pull-left display-block hidden-xs">
                    ...
                    <div class="row">
                        <div class="col-sm-5 ">
                            <a href="#" class="btn btn-falcon-info btn-with-tooltip" data-toggle="tooltip"
                            ...
                            <a href="<?php echo admin_url('leads/switch_kanban/' . $switch_kanban); ?>"
                                class="btn btn-falcon-info mleft5 hidden-xs" data-toggle="tooltip" data-placement="top"
                    ...
                    <div class="container-fluid leads-overview hide my-4 align-items-center">
    <h5 class="font-weight-bold mt-4 text-center text-uppercase mb-2">
        <?php echo _l('leads_summary'); ?>
    </h5>
    <div class="row row-cols-1 row-cols-md-3 g-4 px-2 py-4">
        <?php foreach ($summary as $status) { ?>
            <div class="col">
                <div class="card h-100 border-0 shadow m-2">
                <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url(../assets/falcon/img/corner-4.png);"></div>
                    <div class="card-body d-flex flex-column justify-content-center align-items-center p-3">
                        <span class="font-weight-bold mb-1 text-lg">
                            <?php
                            if (isset($status['percent'])) {
                                echo '<span data-bs-toggle="tooltip" data-bs-placement="top" title="' . $status['total'] . '">' . $status['percent'] . '%</span>';
                            } else {
                                // Is regular status
                                echo $status['total'];
                            }
                        ...
                        <span style="color:<?php echo $status['color']; ?>"
                            class="font-weight-normal <?php echo isset($status['junk']) || isset($status['lost']) ? 'text-danger' : ''; ?>">
        ...
        <?php } ?>
                ...
                <div class="<?php echo $isKanBan ? '' : 'card' ; ?>">
                    <div class="<?php echo $isKanBan ? '' : 'card-body' ; ?>">
                        ...
                        if ($isKanBan) { ?>
                            ...
                            <div class="row" id="leads-table">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="modal bulk_actions" id="leads_bulk_actions" tabindex="-1"
                                        role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                            <h4 class="modal-title text-center mx-auto">
                                                        <?php echo _l('bulk_actions'); ?></h4>
