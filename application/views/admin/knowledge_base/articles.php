...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons mb-1 mb-sm-2">
                    <?php if ($has_permission_create) { ?>
                    <a href="<?php echo admin_url('knowledge_base/article'); ?>" class="btn btn-falcon-info me-1">
                    ...
                    <a href="<?php echo admin_url('knowledge_base/manage_groups'); ?>" class="btn btn-falcon-info me-1">
                        <i class="fas fa-layer-group me-1"></i><?php echo _l('als_kb_groups'); ?>
                    </a>

                    <?php } ?>
                    <a href="#" class="btn btn-falcon-info hidden-xs toggle-articles-list"
