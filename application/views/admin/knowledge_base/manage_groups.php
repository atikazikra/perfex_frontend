        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons mb-2 mb-sm-4">
                    ...
                    <a href="#" onclick="new_kb_group(); return false;" class="btn btn-falcon-info pull-left display-block">
                    <i class="fas fa-plus-circle me-1"></i> 
                    <?php echo _l('new_group'); ?>
                    </a>
                    <?php } ?>
                    <a href="<?php echo admin_url('knowledge_base'); ?>"
                        class="btn btn-falcon-info pull-left display-block ms-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $group['name']; ?> <span
                                                class="badge ms-1"><?php echo total_rows(db_prefix() . 'knowledge_base', 'articlegroup=' . $group['groupid']); ?></span>
                                        </td>
                                        <td>
