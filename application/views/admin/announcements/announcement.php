    ...
    <div class="content">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700 text-uppercase text-center mb-2">
                    <?php echo $title; ?>
                </h4>
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="tw-flex tw-justify-between tw-items-center">
                            ...
                            <button type="submit" class="btn btn-falcon-info"><?php echo _l('submit'); ?></button>
                        </div>
