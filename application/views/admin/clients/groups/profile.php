...
<div class="row">
    ...
    <ul class="nav nav-tabs customer-profile-tabs nav-tabs-horizontal" role="tablist">
        <li role="presentation" class="<?php echo !$this->input->get('tab') ?  : ''; ?>">
            <a class="nav-link " id="contact_info-tab" data-bs-toggle="tab" href="#contact_info"
                aria-controls="contact_info" role="tab" aria-selected="true">
        ...
        if (total_rows(db_prefix() . 'customfields', ['fieldto' => 'customers', 'active' => 1]) > 0) {
            ...
            <li role="presentation" class="<?php if ($this->input->get('tab') == 'custom_fields') {
                ...
                <a class="nav-link " id="custom_fields-tab" data-bs-toggle="tab" href="#custom_fields"
                    aria-controls="custom_fields" role="tab" aria-selected="false">
                    <?php echo hooks()->apply_filters('customer_profile_tab_custom_fields_text', _l('custom_fields')); ?>
                </a>
            </li>
        <?php } ?>
        <li role="presentation">
            <a class="nav-link" id="billing_and_shipping-tab" data-bs-toggle="tab" href="#billing_and_shipping"
                aria-controls="billing_and_shipping" role="tab" aria-selected="false">
        ...
        <?php if (isset($client)) { ?>
            <li role="presentation">
                <a class="nav-link" id="customer_admins-tab" data-bs-toggle="tab" href="#customer_admins"
                    aria-controls="customer_admins" role="tab" aria-selected="false">
