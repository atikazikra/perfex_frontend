        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-right">
                    <a href="<?php echo admin_url('reports/expenses/detailed_report'); ?>" class="btn btn-falcon-success">
                ...
                <?php } ?>
                <a href="#" onclick="make_expense_pdf_export(); return false;" class="btn btn-falcon-info me-2<?php if ($export_not_supported) {
    echo ' disabled';
} ?>">
<i class="far fa-file-pdf"></i>
</a>
                <a download="expenses-report-<?php echo $current_year; ?>.xls" class="btn btn-falcon-info me-2<?php if ($export_not_supported) {
    echo ' disabled';
    ...
    echo 'selected';
                ...
                <div class="card mt-3 mt-sm-3">
                    <div class="card-body">
                            ...
                            <table class="table table-bordered table-condensed table-hover expenses-report"
                                ...
                                <tbody>
                                    ...
                                    <tr class="tw-bg-neutral-50">
                                        ...
                                        <?php } ?>
                                        <td class="text-bold tw-bg-neutral-50">
                                            <?php
                                    ...
                                    <tr class="tw-bg-neutral-50">
                                        <td class="text-bold text-info"><?php echo _l('expenses_report_total_tax'); ?></td>
                                        <?php
                                                    $taxYearlyTotal = 0;
                                                    for ($m = 1; $m <= 12; $m++) {
                                                        echo '<td class="bold">';
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-muted mb-4 text-center fw-semibold"><?php echo _l('not_billable_expenses_by_categories'); ?>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-muted mb-4 text-center fw-semibold"><?php echo _l('billable_expenses_by_categories'); ?></p>
                            </div>
                            <div class="col-md-6">
