...
<div id="wrapper">
  ...
  ?>
            <div class="col-md-12">
            <h4 class="mt-0 fw-normal display-4 mb-2 text-center text-uppercase text-monospace">
                    <span>
...
?>
    ...
    echo _l('discount_fixed_amount');
            ...
            ?>
                ...
                <div class="btn-bottom-pusher mt-2"></div>
                <div class="btn-bottom-toolbar btn-t2oolbar-container-out text-right">
                    <button type="button"
                        class="me-1 btn-tr btn btn-falcon-success mleft10 credit-note-form-submit save-and-send transaction-submit">
                        <?php echo _l('save_and_send'); ?>
                    </button>
                    <button class="btn-tr btn btn-falcon-success mleft5 text-right credit-note-form-submit transaction-submit">
                        <?php echo _l('submit'); ?>
                    </button>
                </div>
            </div>
