...
<div id="wrapper">
    ...
    <h3 class="mt-1 mb-3 font-weight-semibold text-uppercase text-lg text-center">
        <?php echo _l('clients_single_ticket_information_heading'); ?>
    </h3>
    <div class="text-right">
        <button class="btn btn-falcon-info" id="ticket_no_contact">
            <i class="fa-regular fa-envelope me-1"></i> <?php echo _l('ticket_create_no_contact'); ?>
        </button>
        <button class="btn btn-falcon-info hide" id="ticket_to_contact">
            <i class="fa-regular fa-user me-1"></i> <?php echo _l('ticket_create_to_contact'); ?>
        </button>
    </div>
</div>
