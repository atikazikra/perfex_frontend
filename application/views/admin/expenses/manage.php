            ...
            <div class="col-md-12">
                <div class="tw-mb-2 sm:tw-mb-4">
                    <div class="_buttons">
                        ...
                        <a href="<?php echo admin_url('expenses/expense'); ?>" class="btn btn-falcon-info">
                            <i class="fas fa-plus-circle ms-1"></i>
                            <?php echo _l('new_expense'); ?>
                        </a>
                        <a href="<?php echo admin_url('expenses/import'); ?>" class="btn btn-falcon-info mleft5">
                        ...
                        <a href="#" onclick="slideToggle('#stats-top'); return false;"
                            class="pull-right btn btn-falcon-info mleft5 btn-with-tooltip" data-toggle="tooltip"
                            title="<?php echo _l('view_stats_tooltip'); ?>"><i class="far fa-chart-bar"></i></a>
                        <a href="#" class="btn btn-falcon-info pull-right btn-with-tooltip toggle-small-view hidden-xs"
...
<div class="modal" id="expense_convert_helper_modal" tabindex="-1" role="dialog">
