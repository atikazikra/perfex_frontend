...
<div id="wrapper">
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-6">
            <h4 class="m-2 font-weight-bold text-center text-uppercase text-lg">
                    <?php echo $title; ?>
                </h4>
                <div class="card">
                    <div class="card-body">
                     ...
                     ?>
                        ...
                        <?php if (!isset($expense) || (isset($expense) && $expense->attachment == '')) { ?>
                            <div id="dropzoneDragArea" class=" dz-default dz-message card p-5 text-center">
                                    <div class="card-body">
                                        <i class="fas fa-cloud-upload-alt fa-3x mb-3"></i>
                                        <h6 class="card-title"><?php echo _l('expense_add_edit_attach_receipt'); ?></h6>
                                    </div>
                                </div>
