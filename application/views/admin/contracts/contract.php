    ...
    <div class="content">
        <div class="row">
         ...
         if (isset($contract) && $contract->signed == 1) { ?>
            ...
            <h3 class="mt-1 mb-3 text-center font-semibold text-monospace text-uppercase text-lg text-center">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <div class="form-check form-check-inline">
                <input type="checkbox" id="trash" name="trash" class="form-check-input"
                    <?php echo $contract->trash ?? false == 1 ? 'checked' : ''; ?>>
                <label class="form-check-label" for="trash">
                    <i class="far fa-trash-alt" data-toggle="tooltip" data-placement="right"
                        title="<?php echo _l('contract_trash_tooltip'); ?>"></i>
                    <?php echo _l('contract_trash'); ?>
                </label>
            </div>
            <div class="form-check form-check-inline">
                <input type="checkbox" name="not_visible_to_client" id="not_visible_to_client" class="form-check-input"
                    <?php echo $contract->not_visible_to_client ?? false == 1 ? 'checked' : ''; ?>>
                <label class="form-check-label" for="not_visible_to_client">
        ...
        <div class="form-group select-placeholder f_client_id">
            ...
            <select id="clientid" name="client" data-live-search="true" data-width="100%" class="form-control ajax-search"
        ...
        <?php if ((!isset($contract)) || (isset($contract) && !customer_has_projects($contract->client))) {
           echo ' hide';
       } ?>">
            <label for="project_id"><?php echo _l('project'); ?></label>
            <div id="project_ajax_search_wrapper">
                <select name="project_id" id="project_id" class="projects ajax-search ays-ignore" data-live-search="true"
        ...
        <div class="form-group">
            <label for="subject" class="control-label">
                <i class="far fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip"
                    title="<?php echo _l('contract_subject_tooltip'); ?>"></i>
                <?php echo _l('contract_subject'); ?>
            </label>
            <input type="text" class="form-control" id="subject" name="subject" value="<?php echo $value; ?>">
        </div>
