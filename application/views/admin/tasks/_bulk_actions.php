...
<div class="modal bulk_actions" id="tasks_bulk_actions" tabindex="-1" role="dialog" data-table="<?php echo(isset($table) ? $table : '.table-tasks'); ?>">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
         <h4 class="modal-title text-center mx-auto">
         <span  class="modal-title"><?php echo _l('bulk_actions'); ?></span>
         </h4>
            ...
            <div id="bulk_change">
               <div class="form-group">
                  ...
                  <select name="move_to_status_tasks_bulk_action"
                   ...
                   class="selectpicker" data-none-selected-text="<?php echo _l('task_status'); ?>">
                     <option value=""></option>
               ...
               <?php if (has_permission('tasks', '', 'edit')) { ?>
                  ...
                  <?php
                  echo '<i class="far fa-question-circle" data-toggle="tooltip" data-title="' . _l('tasks_bull_actions_assign_notice') . '"></i>';
                ...
                <div class="form-group">
                 ...
                 <select name="task_bulk_billable" class="selectpicker" id="task_bulk_billable"
      ...
      <div class="modal-footer">
         ...
         <a href="#" class="btn btn-success" onclick="tasks_bulk_action(this); return false;"><?php echo _l('confirm'); ?></a>
      </div>
   </div>
   <!-- /.modal-content -->
</div>
