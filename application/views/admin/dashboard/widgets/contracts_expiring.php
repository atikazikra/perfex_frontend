...
<div class="card mb-3 mt-4 widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('contracts_about_to_expire'); ?>">
    ...
    <div class="card-body position-relative">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h3 class="text-center mb-3"><?php echo _l('contracts_about_to_expire'); ?></h3>
                <p class="mb-3"><?php echo _l('contracts_about_to_expire_description'); ?></p>
                <a class="btn btn-primary" href="<?php echo admin_url('contracts'); ?>" target="_blank">
                    <?php echo _l('View All Contracts'); ?>
                </a>
            </div>
        </div>
    </div>
...
<div class="card contracts-expiring widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('contracts_about_to_expire'); ?>">
        ...
        <div class="tw-overflow-y-auto tw-overflow-x-hidden tw-h-[420px] tw-p-2">
            <table class="table dt-table" data-order-col="3" data-order-type="desc">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo '<a href="' . admin_url('contracts/contract/' . $contract['id']) . '">' . $contract['subject'] . '</a>'; ?></td>
                        <td><?php echo '<a href="' . admin_url('clients/client/' . $contract['client']) . '">' . get_company_name($contract['client']) . '</a>'; ?></td>
