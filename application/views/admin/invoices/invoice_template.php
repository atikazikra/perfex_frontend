...
<div class="card invoice accounting-template">
...
<div class="mt-2 btn-bottom-toolbar text-right">
    <?php if (!isset($invoice)) { ?>
    <button class="btn-tr btn btn-info me-2 text-right invoice-form-submit save-as-draft transaction-submit">
