...
<div class="col-md-12">
    <div class="tw-mb-2 sm:tw-mb-4">
        <div class="_buttons">
            ...
            <?php } ?>
            <a href="<?php echo admin_url('invoices'); ?>" class="btn btn-falcon-info pull-left me-1">
                <?php echo _l('go_back'); ?>
            </a>
            <div class="display-block text-right">
                <div class="btn-group pull-right ms-2 invoice-view-buttons btn-with-tooltip-group _filter_data"
    ...
    <div class="row">
        <div class="col-md-12" id="small-table">
            <div class="card card-table-full table-responsive">
                <div class="card-body">
