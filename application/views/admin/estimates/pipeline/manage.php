...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons mb-3 mb-sm-2">
    ...
    $this->load->view('admin/estimates/estimates_top_stats');
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="display-block pull-left ms-2">
                                <a href="#" class="btn btn-falcon-info estimates-total"
                            ...
                            <a href="<?php echo admin_url('estimates/pipeline/' . $switch_pipeline); ?>"
                                class="btn btn-falcon-info mleft5 pull-left" data-toggle="tooltip" data-placement="top"
