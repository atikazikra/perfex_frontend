    ...
    <div class="content accounting-template proposal">
        <div class="row">
         ...
         ?>
            ...
            <div class="col-md-12">
            <h4 class="mt-0 fw-normal mb-2  display-5 text-uppercase text-center">
                    <span>
             ...
             echo '<option value="' . $rel_val['id'] . '" selected>' . $rel_val['name'] . '</option>';
                        ...
                        <div
                            ...
                            <div>
                                <button type="button"
                                    class="btn btn-success ms-3 proposal-form-submit save-and-send transaction-submit">
                                    <?php echo _l('save_and_send'); ?>
                                </button>
                                <button class="btn btn-success ms-2 proposal-form-submit transaction-submit"
                                    type="button">
                                    <?php echo _l('submit'); ?>
                                </button>
                            </div>
