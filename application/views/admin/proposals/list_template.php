    ...
    <div class="mb-2 mb-sm-2">
        <div class="_buttons">
            ...
            <a href="<?php echo admin_url('proposals/proposal'); ?>"
                class="btn btn-falcon-info pull-left display-block new-proposal-btn">
                <i class="fas fa-plus-circle me-1"></i>
                <?php echo _l('new_proposal'); ?>
            </a>
            <?php } ?>
            <a href="<?php echo admin_url('proposals/pipeline/' . $switch_pipeline); ?>"
                class="btn btn-falcon-info ms-2 pull-left switch-pipeline hidden-xs" data-toggle="tooltip"
